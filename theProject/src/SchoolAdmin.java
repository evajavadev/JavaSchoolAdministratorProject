...
public class SchoolAdmin {
    ...
    public SchoolAdmin() {
/*
        User user = new User("fornamn","efternamn","username","email","password","id");
        ...
        Student student = new Student("Marcus",
                "Gyllencreutz",
                "Marcus",
                "marcus.gyllencreutz@lexicon.se","123456789",classroomList.get("1"));

        studentList.put(student.getKey(),student);
        FileIO.writeObject(studentList,"studentlist.ser");
*/
        userList = FileIO.readObject("C:\\Users\\...\\userlist.ser");
        classroomList = FileIO.readObject("C:\\Users\\...\\classroomlist.ser");
        studentList = FileIO.readObject("C:\\Users\\...\\studentlist.ser");
        scanningList = FileIO.readObject("C:\\Users\\...\\scanninglist.ser");
